...
Download the project and copy it to local drive.
In command prompt CD to the project location.
execute below commands in command prompt: <br/>
cd music-festival 
npm start

Now open http://localhost:3000 in the browser to view the result.
